...
if __name__ == "__main__":
    ...
    # download from: http://version10.string-db.org/download/protein.actions.v10/9685.protein.actions.v10.txt.gz
    with open('./workload/stringFC/9685.protein.actions.v10.txt') as f:
        for line in f:
    ...
    with open('./workload/stringFC/graph.nt', mode='w', encoding='utf-8') as out:
        out.write(str(len(d)))
        out.write(',')
